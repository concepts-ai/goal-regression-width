...
from .modules.neural_logic import LogicInference, LogicInferenceMethod
...
class LogicLayer(nn.Module):
    ...
    def __init__(
        ...
        for i in range(self.max_order + 1):
            ...
            if current_dim == 0:
                ...
                self.logic.append(LogicInference(logic_model, current_dim, output_dims[i], logic_hidden_dim))
    ...
    def make_prog_block_parser(cls, parser, defaults, prefix=None):
        ...
        parser.add_argument(prefix + 'logic-model',
                            default=defaults['logic_model'],
                            choices=LogicInferenceMethod.choice_values(), metavar='T',
                            help='logic model choices')
...
class LogicMachine(nn.Module):
    ...
    def __init__(
        ...
        for i in range(depth):
            ...
            layer = LogicLayer(breadth, current_dims, output_dims, logic_model, logic_hidden_dim, exclude_self, residual)
